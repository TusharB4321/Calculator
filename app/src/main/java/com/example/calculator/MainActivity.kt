...
class MainActivity : AppCompatActivity() {
    ...
    private fun calculateResult(): String {
        ...
        val digitOperators=digitalOperator()

        if (digitOperators.isEmpty()) " "

        val timeDivision=timesDivisionCalculate(digitOperators)
    ...
    // ye function Addition and Subtraction krne ke liye hai
    private fun addSubtractCalculate(list: MutableList<Any>): Any {
    ...
    // ye function Division and Into krne ke liye hai
